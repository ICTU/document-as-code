...
intro_sources = f"""
This section lists the example sources for the requirements of the {project} project.
"""

intro_requirements = f"""
This section lists the example requirements applicable to the {project} project.
