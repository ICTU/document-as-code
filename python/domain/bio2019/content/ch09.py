...
Een formele registratie- en afmeldingsprocedure behoort te worden geÃ¯mplementeerd om toewijzing van toegangsrechten mogelijk te maken.
            """,
            bbn=1,
            fragments=[
                Verifier(
...
Een formele gebruikerstoegangsverleningsprocedure behoort te worden geÃ¯mplementeerd om toegangsrechten voor alle typen gebruikers en voor alle systemen en diensten toe te wijzen of in te trekken.
            """,
            bbn=1,
            fragments=[
                Verifier(
...
Het wachtwoordbeleid wordt geautomatiseerd afgedwongen.
                ...
                Verifier(
                    ...
                    title="",
                    text="""
InitiÃ«le wachtwoorden en wachtwoorden die gereset zijn, hebben een maximale geldigheidsduur van een werkdag en moeten bij het eerste gebruik worden gewijzigd.
                    """,
                    bbn=2,
                ),
                Verifier(
