            ...
            fragments=[
                Verifier(
                    ...
                    text="In koppelpunten met externe of onvertrouwde zones zijn maatregelen getroffen om mogelijke "
                         ...
                         "(bijv. DDoS attacks, Distributed Denial of Service attacks) "
            ...
            fragments=[
                ...
                Verifier(
                    ...
                    text="De informatieverwerkende omgeving wordt gemonitord door een SIEM en/of SOC middels "
                         ...
                         "Nationaal Detectie Netwerk (alleen voor rijksoverheidsorganisaties), "
                ...
                Verifier(
                    ...
                    text="Bij ontdekte nieuwe dreigingen (aanvallen) via 12.04.01/03 worden deze binnen geldende "
                         ...
                         "waaronder met het NCSC (alleen voor rijksoverheidsorganisaties) of "
                         "via de sectorale CERT (voor andere overheidsorganisaties), "
                         "middels "
    ...
    fragments=[
        ...
        Norm(
            ...
            text="Informatie over technische kwetsbaarheden van informatiesystemen die worden gebruikt behoort tijdig "
                 ...
                 "ge&euml;valueerd en passende maatregelen te worden genomen om het risico dat ermee samenhangt aan te "
                 "pakken.",
            bbn=1,
            fragments=[
                Verifier(
