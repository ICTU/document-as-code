        ...
        Norm(
            ...
            fragments=[
                Verifier(
                    ...
                    title="",
                    text="Het lijnmanagement heeft een strategie ontwikkeld en geïmplementeerd om blijvend over "
...
S0803 = Section(
    identifier="08.03",
    title="Beëindiging of wijziging van het dienstverband",
    fragments=[
        Norm(
            identifier="08.03.01",
            title="Beëindiging van verantwoordelijkheden",
            text="De verantwoordelijkheden voor beëindiging of wijziging van het dienstverband behoren duidelijk te "
            ...
            fragments=[
                Verifier(
                    ...
                    text="Voor ambtenaren is in de ambtseed of belofte vastgelegd welke verplichtingen ook na "
                         "beëindiging van het dienstverband of bij functiewijziging nog van kracht blijven en "
                ...
                Verifier(
                    ...
                    title="",
                    text="Het lijnmanagement heeft een procedure vastgesteld voor beëindiging van dienstverband, "
                         "contract of overeenkomst waarin minimaal aandacht besteed wordt aan het intrekken van "
                         "toegangsrechten, innemen van bedrijfsmiddelen en welke verplichtingen ook na beëindiging "
        ...
        Norm(
            ...
            text="Alle werknemers, ingehuurd personeel en externe gebruikers behoren alle bedrijfsmiddelen van de "
                 "organisatie die ze in hun bezit hebben te retourneren bij beëindiging van hun dienstverband, "
