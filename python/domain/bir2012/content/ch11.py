        ...
        Norm(
            ...
            fragments=[
                Verifier(
                    ...
                    title=u"",
                    text=u"Gebruikers worden vooraf geïdentificeerd en geautoriseerd. Van de registratie wordt een "
                         u"administratie bijgehouden.",
                ),
                Verifier(
                    identifier="11.02.01/02",
                    title=u"",
                    text=u"Authenticatiegegevens worden bijgehouden in één bronbestand) zodat consistentie is "
                         u"gegarandeerd.",
                ),
                Verifier(
        ...
        Norm(
            ...
            fragments=[
                Verifier(
                    ...
                    title=u"",
                    text=u"Toegangsrechten van gebruikers worden periodiek, minimaal jaarlijks, geëvalueerd. Het "
        ...
        Norm(
            ...
            fragments=[
                Verifier(
                    ...
                    title=u"",
                    text=u"Alleen geïdentificeerde en geauthenticeerde apparatuur kan worden aangesloten op "
            ...
            fragments=[
                ...
                Verifier(
                    ...
                    text=u"De indeling van zones binnen de technische infrastructuur vindt plaats volgens een "
                         ...
                         u"periodiek, minimaal één keer per jaar, geëvalueerd of het systeem nog steeds in de "
        ...
        Norm(
            ...
            fragments=[
                ...
                Verifier(
                    ...
                    title=u"",
                    text=u"Wachtwoorden die gereset zijn en initiële wachtwoorden hebben een zeer beperkte "
            ...
            fragments=[
                Verifier(
                    ...
                    text=u"Gevoelige systemen (met hoge beschikbaarheid of grote vertrouwelijkheid) behoren een eigen "
                         u"vast toegewezen (geïsoleerde) computeromgeving te hebben. Isoleren kan worden bereikt door "
