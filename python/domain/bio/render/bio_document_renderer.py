...
class BioDocumentRenderer(object):
    ...
    def __init__(self, labeler_class):
        super().__init__()
        self.todo = BioMeasure("TODO", "Things left todo", identifiers=[])
        self.explain = BioMeasure.explain()
        self.not_applicable = BioMeasure.not_applicable()
    ...
    def render_measures_annex(self, measures=None):
        ...
        measures_to_report = set(measures if measures else BioMeasure.all) - set(specials)
    ...
    def link_measures_to_fragments(self, fragment):
        ...
        fragment.bio_measures.update(BioMeasure.all_applicable_to_fragment(fragment.identifier))
